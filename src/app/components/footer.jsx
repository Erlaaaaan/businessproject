      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <h3 className="text-2xl font-bold text-blue-400">BusinessPro</h3>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.174-.105-.949-.199-2.403.041-3.439.219-.937 1.406-5.957 1.406-5.957s-.359-.72-.359-1.781c0-1.663.967-2.911 2.168-2.911 1.024 0 1.518.769 1.518 1.688 0 1.029-.653 2.567-.992 3.995-.283 1.194.599 2.169 1.775 2.169 2.128 0 3.768-2.245 3.768-5.487 0-2.861-2.063-4.869-5.008-4.869-3.41 0-5.409 2.562-5.409 5.199 0 1.033.394 2.143.889 2.741.099.12.112.225.085.345-.09.375-.293 1.199-.334 1.363-.053.225-.172.271-.402.165-1.495-.69-2.433-2.878-2.433-4.646 0-3.776 2.748-7.252 7.92-7.252 4.158 0 7.392 2.967 7.392 6.923 0 4.135-2.607 7.462-6.233 7.462-1.214 0-2.357-.629-2.746-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146C9.57 23.812 10.763 24.009 12.017 24.009c6.624 0 11.99-5.367 11.99-11.988C24.007 5.367 18.641.001 12.017.001z"/>
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blogs" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Blog & Insights
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/strategy" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Business Strategy
                </Link>
              </li>
              <li>
                <Link href="/digital" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Digital Transformation
                </Link>
              </li>
              <li>
                <Link href="/consulting" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Management Consulting
                </Link>
              </li>
              <li>
                <Link href="/marketing" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Digital Marketing
                </Link>
              </li>
              <li>
                <Link href="/analytics" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  Data Analytics
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <a href="tel:+1-555-123-4567" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
                  +1 (555) 123-4567
                </a>
              </div>
              ...
              <div className="flex items-center">
                ...
                <a href="mailto:info@businesspro.com" className="text-gray-300 hover:text-blue-400 transition-colors duration-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Subscribe to our newsletter for the latest business insights, industry trends, and exclusive content delivered to your inbox.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm mb-4 md:mb-0">
              © {currentYear} BusinessPro. All rights reserved.
            </div>
